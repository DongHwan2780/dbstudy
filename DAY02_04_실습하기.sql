-- 1. 사원 테이블에서 부서 번호의 중복을 제거하고 조회하기
...
-- 5. 사원 테이블에서 부서번호가 30, 40 50 인 사원의 정보 조회하기
SELECT * 
    FROM EMPLOYEES
...
-- 8. 사원 테이블에서 상사가 없는 사람의 정보 조회하기
SELECT * 
    FROM EMPLOYEES
 WHERE MANAGER_ID IS NULL;

-- 9. 사원 테이블에서 전화번호가 515로 시작하는 사원의 정보 조회하기
SELECT * 
    FROM EMPLOYEES
 WHERE PHONE_NUMBER LIKE '515%';

-- 10. 사원 테이블에서 직업이 man으로 끝나는 사원의 정보 조회하기
SELECT * 
    FROM EMPLOYEES
